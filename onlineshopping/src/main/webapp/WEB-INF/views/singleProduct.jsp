	...
	<div class="col-xs-12 col-sm-8">
		...
		<sf:form modelAttribute=""
			...
			<div class="form-group">
				<label for="product_review" class="control-label col-md-4"
					style="font-size: 19pt">Add Review</label>
				<div class="col-md-8">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-8">
					<div style="color: orange">
						<span class="heading">Rating :</span> <span
